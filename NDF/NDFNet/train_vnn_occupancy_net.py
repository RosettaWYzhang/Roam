...
p.add_argument('--chair_path', type=str, default="../../data/ndf_data/shapenet_pointcloud/03001627")
p.add_argument('--sofa_path', type=str, default="../../data/ndf_data/shapenet_pointcloud/04256520")

opt = p.parse_args()


train_dataset = dataio.JointOccTrainDataset(phase='train', obj_class=opt.obj_class, chair_path=opt.chair_path, sofa_path=opt.sofa_path)
val_dataset = dataio.JointOccTrainDataset(phase='val', obj_class=opt.obj_class, chair_path=opt.chair_path, sofa_path=opt.sofa_path)
